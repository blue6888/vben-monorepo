import type { VxeTableGridOptions } from '@web/plugins/vxe-table';
...
import { $te } from '@web/locales';
import {
  setupVbenVxeTable,
  useVbenVxeGrid as useGrid,
} from '@web/plugins/vxe-table';
import { get, isFunction, isString } from '@web/utils';
